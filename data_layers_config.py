...
MONOGRAPH_ITEM_MODS_MAP = {
    ...
    'creator': {'bs_exp':'name > namePart'}, # with certain roleTerm values TBD, including author, composer, editor
    'contributor': {'bs_exp':'name > namePart'}, # with certain roleTerm values that not associated with Creator
