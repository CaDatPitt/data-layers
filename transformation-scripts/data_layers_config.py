...
SERIAL_CATALOG_ITEM_MODS_MAP = {
    ...
    'oclccn': {'bs_exp':['mods > identifier[type=\"oclcn\"]']},
    'url': {'bs_exp':['mods > location > url',]}
}

SERIAL_DIGITAL_ITEM_MODS_MAP = {
    'id': {'bs_exp':['mods > identifier[type=\"pitt\"]',]},
    'title':{'bs_exp':['mods > titleInfo:not([type])',]},
    'uniform_title': {'bs_exp':['mods > titleInfo[type=\"uniform\"] > title',]},
    'alternative_title': {'bs_exp':['mods > titleInfo[type=\"alternative\"] > title',]},
...
SERIAL_MIXED_ITEM_MODS_MAP = {
    'id': {'bs_exp':['mods > identifier[type=\"pitt\"]', 'recordIdentifier']},
    'title':{'bs_exp':['mods > titleInfo:not([type])',]},
    'uniform_title': {'bs_exp':['mods > titleInfo[type=\"uniform\"] > title',]},
    'alternative_title': {'bs_exp':['mods > titleInfo[type=\"alternative\"] > title',]},
    'enumeration_chronology': {'bs_exp':['mods > titleInfo > partNumber',]},
...
MONOGRAPH_CATALOG_ITEM_MODS_MAP = {
...
MONOGRAPH_DIGITAL_ITEM_MODS_MAP = {
    'id': {'bs_exp':['mods > identifier[type=\"pitt\"]',]},
    'title':{'bs_exp':['mods > titleInfo:not([type])',]},
    'uniform_title': {'bs_exp':['mods > titleInfo[type=\"uniform\"] > title',]},
    'alternative_title': {'bs_exp':['mods > titleInfo[type=\"alternative\"] > title',]},
